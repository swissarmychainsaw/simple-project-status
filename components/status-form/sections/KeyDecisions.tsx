...
const KeyDecisions: React.FC = () => {
  ...
  const valueHtml = (formData?.keyDecisionsHtml as string | undefined) ?? "";
  ...
  const save = useCallback(() => {
    writeFormData({ keyDecisionsHtml: draft });
    setEditing(false);
  }, [draft, writeFormData]);
  ...
  return (
    <div className="space-y-3">
      <div className="flex items-center justify-between">
        <h3 className="text-base font-semibold">Key decisions</h3>
        <button
          type="button"
